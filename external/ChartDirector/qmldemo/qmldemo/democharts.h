...
struct DemoChart
{
    ...
    void (*createChart)(QmlChartViewer* viewer, int chartIndex);	//the demo function entry point
    const char *path;   //For a folder, it is the icon path. For a QML demo, is the the QML path.
};
