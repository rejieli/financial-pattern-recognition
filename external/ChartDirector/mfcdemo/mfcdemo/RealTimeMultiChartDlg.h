// CRealTimeMultiChartDlg.h : header file
//
...
class CRealTimeMultiChartDlg : public CDialog
{
public:
	CRealTimeMultiChartDlg(CWnd* pParent = NULL);	// standard constructor
	~CRealTimeMultiChartDlg();

#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_REALTIMEMULTICHART };
#endif
...
protected:
	...
	// Draw chart
	XYChart* drawXYChart(CChartViewer* viewer, const double* dataSeries, const char* name,
